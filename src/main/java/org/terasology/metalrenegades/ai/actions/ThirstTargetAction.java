...
import org.terasology.metalrenegades.ai.component.WaterSourceComponent;
import org.terasology.minion.move.MinionMoveComponent;
import org.terasology.registry.In;

@BehaviorAction(name = "set_target_water_source")
public class ThirstTargetAction extends BaseAction {
    ...
    public BehaviorState modify(Actor actor, BehaviorState result) {
        ...
        for (EntityRef source : entityManager.getEntitiesWith(WaterSourceComponent.class)) {
