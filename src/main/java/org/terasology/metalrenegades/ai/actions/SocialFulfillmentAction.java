...
/**
 * Restores the social value of a citizen to maximum.
 */
@BehaviorAction(name = "social_fulfillment")
public class SocialFulfillmentAction extends BaseAction {

    @Override
    public BehaviorState modify(Actor actor, BehaviorState result) {
        NeedsComponent needsComponent = actor.getComponent(NeedsComponent.class);
        needsComponent.socialValue = needsComponent.maxSocialCapacity;
