...
/**
 * Restores the food value of a citizen to maximum.
 */
@BehaviorAction(name = "replenish_food")
public class ReplenishFoodAction extends BaseAction {

    @Override
    public BehaviorState modify(Actor actor, BehaviorState result) {
        NeedsComponent needsComponent = actor.getComponent(NeedsComponent.class);
        needsComponent.foodValue = needsComponent.maxFoodCapacity;
