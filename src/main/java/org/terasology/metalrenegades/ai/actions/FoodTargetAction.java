...
import org.terasology.metalrenegades.ai.component.FoodSourceComponent;
import org.terasology.minion.move.MinionMoveComponent;
import org.terasology.registry.In;

/**
 * Sets this citizen's target to the nearest food source, defined with a {@link FoodSourceComponent}.
 */
@BehaviorAction(name = "set_target_food_source")
public class FoodTargetAction extends BaseAction {
    ...
    public BehaviorState modify(Actor actor, BehaviorState result) {
        ...
        for (EntityRef source : entityManager.getEntitiesWith(FoodSourceComponent.class)) {
